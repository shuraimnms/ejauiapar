...
export const Route = createFileRoute("/advisory-board")({
  head: () => ({
    meta: [
      { title: "International Advisory Board — EJAUIAPAR" },
      { name: "description", content: "Senior scholars and practitioners advising EJAUIAPAR on strategic direction, ethics, and long-term editorial policy." },
      { property: "og:title", content: "Advisory Board — EJAUIAPAR" },
      { property: "og:description", content: "Strategic advisors to EJAUIAPAR." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Distinguished scholars and practitioners who shape EJAUIAPAR's long-term direction, ethics posture, and international presence."
      />
      <div className="container-page py-12">
        ...
        <CtaStrip
          ...
          title="Full transparency about how EJAUIAPAR is run"

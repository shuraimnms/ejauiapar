  ...
  head: () => ({
    meta: [
      { title: "Past Conferences (2015 – 2026) — EJAUIAPAR" },
      {
        name: "description",
        content:
          "Archive of every EJAUIAPAR international conference and its published proceedings, from 2015 to 2026.",
      },
      { property: "og:title", content: "Past Conferences — EJAUIAPAR" },
      {
        property: "og:description",
        content:
          "Year-wise tree of EJAUIAPAR conferences, venues, and conference proceedings volumes.",
      },
    ],
        ...
        <div className="grid gap-6 p-6 lg:grid-cols-[minmax(0,3fr)_minmax(0,2fr)]">
          ...
          <div className="rounded-lg border border-border bg-secondary/40 p-5">
            ...
            <p className="mt-4 text-xs text-muted-foreground">
              ...
              as an EJAUIAPAR proceedings volume with individual DOIs.
            </p>
          </div>
        </div>
      ) : null}

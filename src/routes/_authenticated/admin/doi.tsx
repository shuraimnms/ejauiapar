      ...
      <header className="mb-6 flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Mint DOIs for published articles and track Crossref deposit history. Format: <code className="rounded bg-muted px-1.5 py-0.5 text-xs">10.63001/ejauiapar.&lt;slug&gt;</code>
          </p>
        </div>

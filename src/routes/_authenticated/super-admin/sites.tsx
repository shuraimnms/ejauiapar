              ...
              <div className="grid grid-cols-2 gap-3">
                <label className="block">
                  ...
                  <input value={edit.code ?? ""} onChange={(e) => setEdit({ ...edit, code: e.target.value.toUpperCase() })}
                    placeholder="EJAUIAPAR" className="h-10 w-full rounded-md border border-slate-800 bg-slate-950 px-3 font-mono text-sm text-white focus:border-amber-400/60 focus:outline-none" />
                </label>
                <label className="block">

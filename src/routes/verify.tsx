...
export const Route = createFileRoute("/verify")({
  head: () => ({
    meta: [
      { title: "Verify a Certificate — EJAUIAPAR" },
      { name: "description", content: "Verify the authenticity of any EJAUIAPAR certificate by its tracking number." },
      { property: "og:title", content: "Verify a Certificate — EJAUIAPAR" },
      { property: "og:description", content: "Verify EJAUIAPAR publication, reviewer, and conference certificates." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        title="Verify an EJAUIAPAR certificate"
        intro="Every certificate we issue has a unique EJAUIAPAR-YYYY-#### tracking number. Enter it below to confirm its authenticity in real time."
      />
        ...
        <form onSubmit={submit} className="mx-auto flex max-w-xl flex-col gap-3 sm:flex-row">
          <div className="relative flex-1">
            ...
            <input
              ...
              placeholder="e.g. EJAUIAPAR-2026-4092"
  ...
  return (
    <div className="rounded-2xl border border-dashed border-border bg-secondary/30 p-10 text-center">
      ...
      <p className="mt-2 text-sm text-muted-foreground">
        The tracking number appears on every EJAUIAPAR certificate under the recipient's name.
      </p>
    </div>
  );
}

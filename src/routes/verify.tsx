...
export const Route = createFileRoute("/verify")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Verify the authenticity of any EJAUIAPAR certificate by its tracking number.",
      },
      { property: "og:title", content: "Verify a Certificate — EJAUIAPAR" },
      {
        property: "og:description",
        content: "Verify EJAUIAPAR publication, reviewer, and conference certificates.",
      },
    ],

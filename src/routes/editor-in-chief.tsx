...
export const Route = createFileRoute("/editor-in-chief")({
  head: () => ({
    meta: [
      { title: "Editor-in-Chief — EJAUIAPAR" },
      { name: "description", content: "Meet the Editor-in-Chief leading the editorial direction and integrity of EJAUIAPAR." },
      { property: "og:title", content: "Editor-in-Chief — EJAUIAPAR" },
      { property: "og:description", content: "Editorial leadership of EJAUIAPAR." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Setting the scholarly direction, safeguarding editorial independence, and championing the highest standards of peer review at EJAUIAPAR."
      />
            ...
            <div className="lg:sticky lg:top-24 lg:self-start">
              ...
              <div className="mt-6 rounded-xl border border-border bg-card p-5 text-sm">
                ...
                {chief.email ? (
                  ...
                  <p className="mt-2 text-muted-foreground">editor@ejauiapar.org</p>
                )}
              </div>
            </div>

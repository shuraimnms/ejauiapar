...
export const Route = createFileRoute("/editorial-board")({
  head: () => ({
    meta: [
      { title: "Editorial Board — EJAUIAPAR" },
      { name: "description", content: "Editors, advisory board members, and peer reviewers of EJAUIAPAR." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Researchers and practitioners who guide, review, and safeguard the scientific integrity of EJAUIAPAR."
      />

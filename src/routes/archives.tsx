  ...
  head: () => ({
    meta: [
      { title: "Archives (2015 – 2026) — EJAUIAPAR" },
      {
        name: "description",
        content:
          "Complete EJAUIAPAR publication archive — Volumes 1 through 12, quarterly issues (March, June, September, December) since 2015.",
      },
      { property: "og:title", content: "EJAUIAPAR Publication Archive (2015 – 2026)" },
      {
        property: "og:description",
        content:
          "Browse every volume and issue of EJAUIAPAR from Volume 1 (2015) to the current Volume 12 (2026).",
      },
    ],
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-serif text-base font-semibold">
                EJAUIAPAR is published <span className="text-brand">QUARTERLY</span> in March, June,

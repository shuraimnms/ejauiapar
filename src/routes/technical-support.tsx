  ...
  head: () => ({
    meta: [
      { title: "Technical Support — EJAUIAPAR" },
      {
        name: "description",
        content:
          "Get help with account access, submission uploads, DOI look-up, certificate verification, and any technical issue with the EJAUIAPAR platform.",
      },
...
const FAQS = [
  ...
  },
  {
    ...
    a: "Log in to your author dashboard — every submission is listed with its ID (EJAUIAPAR-YYYY-####). If the account is inaccessible, contact the editorial office with your registered email.",
  },
];

...
export const Route = createFileRoute("/technical-support")({
  head: () => ({
    meta: [
      { title: "Technical Support — EJAUIAPAR" },
      { name: "description", content: "Get help with account access, submission uploads, DOI look-up, certificate verification, and any technical issue with the EJAUIAPAR platform." },
      { property: "og:title", content: "Technical Support — EJAUIAPAR" },
...
const FAQS = [
  ...
  { q: "How do I recover a submission ID?", a: "Log in to your author dashboard — every submission is listed with its ID (EJAUIAPAR-YYYY-####). If the account is inaccessible, contact the editorial office with your registered email." },
];
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Practical help for authors, reviewers, and readers using the EJAUIAPAR platform. Most issues are resolved on first reply."
      />
      <div className="container-page py-12">
        ...
        <section className="mt-14 grid gap-6 lg:grid-cols-2">
          <div className="rounded-2xl border border-brand/30 bg-gradient-to-br from-brand-muted/40 to-background p-8">
            ...
            <a href="mailto:support@ejauiapar.com" className="mt-4 inline-block font-mono text-sm text-brand hover:underline">support@ejauiapar.com</a>
          </div>
          <div className="rounded-2xl border border-border bg-card p-8">
            ...
            <a href="mailto:editorial@ejauiapar.com" className="mt-4 inline-block font-mono text-sm text-brand hover:underline">editorial@ejauiapar.com</a>
          </div>
        </section>

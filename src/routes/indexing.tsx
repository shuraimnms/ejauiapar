  ...
  head: () => ({
    meta: [
      { title: "Abstracting & Indexing — EJAUIAPAR" },
      {
        name: "description",
        content:
          "EJAUIAPAR is discoverable through global indexing and abstracting services, DOI registration via Crossref, and open-access directories.",
      },
      { property: "og:title", content: "Abstracting & Indexing — EJAUIAPAR" },
      {
        property: "og:description",
        content: "Discovery services, DOI registration, and indexing partners for EJAUIAPAR.",
      },
    ],
...
const SERVICES: Service[] = [
  ...
  },
  {
    ...
    category: "Discovery",
    icon: Search,
    body: "EJAUIAPAR articles are structured with Highwire / Dublin Core meta tags for automatic Google Scholar harvesting and citation tracking.",
    to: "/google-scholar",
  },
  {
    ...
    category: "Directory",
    icon: BookMarked,
    body: "Application filed with the Directory of Open Access Journals. EJAUIAPAR already meets DOAJ's transparency, peer-review, and open-access criteria while the review is in progress.",
  },
  {
...
const FAQS = [
  {
    q: "How can I confirm a specific EJAUIAPAR article is indexed?",
          ...
          <div className="flex flex-wrap items-end justify-between gap-3">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-muted-foreground">
                ...
                make EJAUIAPAR content discoverable to researchers, librarians, and funders
                worldwide.
              </p>
            </div>
        ...
        <section className="mt-16 grid gap-8 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)]">
          <div className="rounded-2xl border border-border bg-card p-8">
            ...
            <h2 className="mt-3 font-serif text-2xl font-semibold">
              How EJAUIAPAR stays discoverable
            </h2>
            <div className="mt-2 rule-gold" />
          ...
          <div className="relative overflow-hidden rounded-2xl border border-brand/30 bg-gradient-to-br from-brand-muted/60 to-background p-8">
            ...
            <div className="relative">
              ...
              <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
                EJAUIAPAR is a Crossref member. On final publication, each article is minted a DOI
                in the form
                <code className="mx-1 rounded bg-secondary px-1.5 py-0.5 text-xs">
                  10.xxxxx/ejauiapar.v{"{"}vol{"}"}.i{"{"}iss{"}"}.###
                </code>

  ...
  head: () => ({
    meta: [
      { title: "Vision & Mission — EJAUIAPAR" },
      {
        name: "description",
        content:
          "The vision, mission, and commitments guiding the European Journal of Ayurvedic, Unani and Interdisciplinary Pharmaceuticals & Allopathic Review.",
      },
        ...
        <section className="grid gap-6 lg:grid-cols-2">
          <article className="rounded-2xl border border-brand/30 bg-gradient-to-br from-brand-muted/60 to-transparent p-8">
            ...
            <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
              EJAUIAPAR promotes a research culture in which original ideas, reliable evidence,

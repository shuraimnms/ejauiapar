  ...
  head: () => ({
    meta: [
      { title: "EJAUIAPAR — European Journal of Ayurvedic, Unani and Interdisciplinary Pharmaceuticals & Allopathic Review" },
      {
        name: "description",
        content:
          "EJAUIAPAR is a peer-reviewed, open access journal publishing innovative research in Ayurveda, Unani Medicine, Pharmaceutical Sciences, Integrative Healthcare, and Allopathic Medicine.",
      },
      { property: "og:title", content: "EJAUIAPAR — European Journal of Ayurvedic, Unani and Interdisciplinary Pharmaceuticals & Allopathic Review" },
      {
        ...
        content: "Peer-reviewed, open access quarterly journal in Ayurveda, Unani Medicine, Pharmaceutical Sciences, Integrative Healthcare, and Allopathic Medicine.",
      },
    ],
...
const FEATURES = [
  { icon: Globe, title: "European Healthcare Journal", body: "Focused on global and European healthcare standards" },
  { icon: Unlock, title: "Open Access", body: "Freely available for reading and download" },
  { icon: Zap, title: "Fast Publication", body: "Rapid peer-review and swift publication workflow" },
    ...
    <SiteLayout>
            ...
            <div className="grid gap-8 md:grid-cols-[minmax(0,1.35fr)_minmax(0,1fr)] items-start">
              ...
              <div>
                <h1 className="font-serif text-3xl md:text-4xl lg:text-[2.6rem] font-bold uppercase leading-[1.15] text-brand">
                  ...
                  <span className="block text-brand/90">(EJAUIAPAR)</span>
                </h1>
                <p className="mt-5 text-[15px] leading-relaxed text-muted-foreground max-w-xl">
                  EJAUIAPAR is a peer-reviewed, open access journal committed to publishing
                  innovative and influential research in Ayurveda, Unani Medicine, Pharmaceutical Sciences, Integrative Healthcare, and Allopathic Medicine.
                </p>
              ...
              <div className="mx-auto w-full max-w-[280px]">
                <div className="relative aspect-[3/4] rounded-sm border border-border bg-[oklch(0.97_0.02_75)] shadow-elev overflow-hidden">
                  ...
                  <div className="flex h-full flex-col items-center justify-center px-6 text-center">
                    <div className="font-serif text-4xl font-bold text-brand">EJAUIAPAR</div>
        ...
        <div className="container-page relative py-14 lg:py-16">
          <div className="text-center">
            ...
            <p className="mx-auto mt-3 max-w-2xl text-sm md:text-[15px] text-white/75">
              EJAUIAPAR has been advancing peer-reviewed research in Ayurveda, Unani Medicine, Pharmaceutical Sciences,
              Integrative Healthcare, and Allopathic Medicine with global visibility, ethical publishing and open access.
            </p>
          </div>
          ...
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.5fr)] lg:items-center">
            <div>
              ...
              <p className="mt-4 text-sm md:text-[15px] text-muted-foreground leading-relaxed">
                EJAUIAPAR welcomes original manuscripts across Ayurveda, Unani Medicine, Pharmaceutical Sciences,
                Integrative Healthcare, and Allopathic Medicine, ranging from clinical trials and pharmacological 
                studies to case reports and interdisciplinary medical reviews.
              </p>
              <Link
                to="/aims-scope"
          ...
          <div className="grid items-center gap-8 md:grid-cols-[minmax(0,1.6fr)_minmax(0,1fr)]">
            <div className="text-white">
              ...
              <p className="mt-3 max-w-xl text-sm md:text-[15px] text-white/80">
                Original, unpublished research in Ayurveda, Unani Medicine, Pharmaceutical Sciences, Integrative Healthcare, and Allopathic Medicine is
      ...
      <section className="border-t border-border bg-card">
        <div className="container-page grid gap-6 py-8 md:grid-cols-3">
          ...
          <ContactItem icon={Globe2} label="WEBSITE" value="www.ejauiapar.com" />

        ...
        <div className="relative z-10 container-page h-full flex items-center">
          <div className="w-full max-w-[650px] bg-transparent px-4 py-24 sm:px-6 md:py-10 md:px-10 md:pt-16 relative z-10">
            ...
            <div className="flex flex-wrap gap-4 mb-10 relative z-20">
              <Link
                to="/current-issue"
                className="bg-[#fcd34d] hover:brightness-110 text-white font-bold text-[15px] px-8 py-3.5 rounded-full transition-all shadow-[0_4px_14px_0_rgba(0,0,0,0.3)] hover:shadow-[0_6px_20px_rgba(255,255,255,0.15)] hover:-translate-y-0.5"
              >
                Explore Research
              </Link>
              <Link

...
export const Route = createFileRoute("/editorial-office")({
  head: () => ({
    meta: [
      { title: "Editorial Office — EJAUIAPAR" },
      { name: "description", content: "Contact details, working hours, and remit of the EJAUIAPAR editorial office — the operational heart of the journal." },
      { property: "og:title", content: "Editorial Office — EJAUIAPAR" },
      { property: "og:description", content: "How to reach the EJAUIAPAR editorial office." },
    ],
...
const CHANNELS = [
  { icon: Mail, label: "Editorial email", value: "editorial@ejauiapar.com", href: "mailto:editorial@ejauiapar.com" },
  { icon: Mail, label: "Technical support", value: "support@ejauiapar.com", href: "mailto:support@ejauiapar.com" },
  { icon: Phone, label: "Phone (office hours)", value: "+91 000 000 0000", href: "tel:+910000000000" },
  { icon: MapPin, label: "Correspondence", value: "EJAUIAPAR Editorial Office, Registered Address (to be published).", href: "#" },
];
...
const FAQS = [
  ...
  { q: "Can I visit the editorial office?", a: "EJAUIAPAR operates a distributed editorial team. All correspondence is handled by email; in-person meetings are by scheduled appointment at conferences." },
  { q: "Whom should I contact about DOIs or metadata corrections?", a: "Email editorial@ejauiapar.com with your article DOI and the correction requested. Metadata is re-deposited with Crossref within five working days." },
];
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="The EJAUIAPAR editorial office is the operational heart of the journal — coordinating peer review, ethics, production, and post-publication support."
      />

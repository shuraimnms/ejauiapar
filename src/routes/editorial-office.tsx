  ...
  head: () => ({
    meta: [
      { title: "Editorial Office — EJAUIAPAR" },
      {
        name: "description",
        content:
          "Contact details, working hours, and remit of the EJAUIAPAR editorial office — the operational heart of the journal.",
      },
...
const CHANNELS = [
  {
    ...
    value: "editorial@ejauiapar.com",
    href: "mailto:editorial@ejauiapar.com",
  },
  {
    icon: Mail,
    label: "Technical support",
    value: "support@ejauiapar.com",
    href: "mailto:support@ejauiapar.com",
  },
  {
    icon: Phone,
  ...
  },
  {
    ...
    value: "EJAUIAPAR Editorial Office, Registered Address (to be published).",
    href: "#",
  },
];
...
const FAQS = [
  ...
  },
  {
    ...
    a: "EJAUIAPAR operates a distributed editorial team. All correspondence is handled by email; in-person meetings are by scheduled appointment at conferences.",
  },
  {
    q: "Whom should I contact about DOIs or metadata corrections?",
    a: "Email editorial@ejauiapar.com with your article DOI and the correction requested. Metadata is re-deposited with Crossref within five working days.",
  },
];

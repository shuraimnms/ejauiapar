...
export const Route = createFileRoute("/ebooks")({
  head: () => ({
    meta: [
      { title: "E-Books — EJAUIAPAR" },
      { name: "description", content: "Open-access e-books curated by EJAUIAPAR." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        eyebrow="Library"
        title="E-Books"
        intro="Curated open-access volumes drawn from EJAUIAPAR research."
      />

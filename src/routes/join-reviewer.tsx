  ...
  head: () => ({
    meta: [
      { title: "Become a Peer Reviewer — EJAUIAPAR" },
      {
        name: "description",
        content:
          "Apply to join the EJAUIAPAR standing peer-review panel. Recognised contributions, reviewer certificates, and priority consideration for editorial roles.",
      },
...
const BENEFITS = [
  {
    ...
    body: "A verifiable EJAUIAPAR-YYYY-#### certificate for every completed review, publicly verifiable on our /verify page.",
  },
  {
    icon: ShieldCheck,
...
const FAQS = [
  ...
  },
  {
    ...
    a: "EJAUIAPAR uses double-blind review. Author identity is stripped from manuscripts before you receive them, and your identity is never shared with the authors.",
  },
  {
                ...
                <div className="mt-4">
                  <label className="block">
                    <div className="mb-1 text-xs uppercase tracking-wider text-muted-foreground">
                      Why do you want to review for EJAUIAPAR?
                    </div>
                    <textarea
                      rows={5}
                      value={f.motivation}

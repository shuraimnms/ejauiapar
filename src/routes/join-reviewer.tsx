...
export const Route = createFileRoute("/join-reviewer")({
  head: () => ({
    meta: [
      { title: "Become a Peer Reviewer — EJAUIAPAR" },
      { name: "description", content: "Apply to join the EJAUIAPAR standing peer-review panel. Recognised contributions, reviewer certificates, and priority consideration for editorial roles." },
      { property: "og:title", content: "Join as Reviewer — EJAUIAPAR" },
      { property: "og:description", content: "Apply to review for EJAUIAPAR." },
    ],
...
const BENEFITS = [
  { icon: Award, title: "Reviewer certificate", body: "A verifiable EJAUIAPAR-YYYY-#### certificate for every completed review, publicly verifiable on our /verify page." },
...
const CRITERIA = [
  ...
  "Demonstrable expertise in one or more EJAUIAPAR subject areas.",
...
const FAQS = [
  ...
  { q: "How is my identity protected?", a: "EJAUIAPAR uses double-blind review. Author identity is stripped from manuscripts before you receive them, and your identity is never shared with the authors." },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        title="Become an EJAUIAPAR peer reviewer"
              ...
              <form onSubmit={submit} className="rounded-2xl border border-border bg-card p-6 lg:p-8">
                ...
                <div className="mt-4">
                  <label className="block">
                    <div className="mb-1 text-xs uppercase tracking-wider text-muted-foreground">Why do you want to review for EJAUIAPAR?</div>
                    <textarea
                      rows={5}
                      value={f.motivation}

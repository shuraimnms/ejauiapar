...
export const Route = createFileRoute("/reviewers")({
  head: () => ({
    meta: [
      { title: "Reviewer Board — EJAUIAPAR" },
      { name: "description", content: "Search the standing peer-review panel of EJAUIAPAR — expert reviewers across commerce and management, drawn from institutions worldwide." },
      { property: "og:title", content: "Reviewer Board — EJAUIAPAR" },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="Every published article in EJAUIAPAR has passed through the hands of at least two independent, double-blind peer reviewers drawn from this standing panel."
      />

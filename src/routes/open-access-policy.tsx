...
export const Route = createFileRoute("/open-access-policy")({
  head: () => ({
    meta: [
      { title: "Open Access Policy — EJAUIAPAR" },
      { name: "description", content: "EJAUIAPAR provides open access to published content to promote wider dissemination of academic knowledge." },
      { property: "og:title", content: "Open Access Policy — EJAUIAPAR" },
      { property: "og:description", content: "Open access statement, user and author responsibilities, and archiving policy of EJAUIAPAR." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="EJAUIAPAR provides open access to its published content with the objective of promoting wider dissemination and exchange of academic knowledge."
      />
      <div className="container-page py-12">
        ...
        <section className="mt-12 grid gap-6 lg:grid-cols-2">
          <article className="rounded-2xl border border-border bg-card p-6 lg:p-8">
            ...
            <p className="mt-3 text-sm text-muted-foreground">Readers using EJAUIAPAR content must:</p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                EJAUIAPAR follows open access. A specific Creative Commons licence has not yet been formally adopted by the journal administration. Until adoption, no CC BY, CC BY-NC, or other licence badge is displayed on published articles.
              </p>
            </div>
          </div>
        </section>

  ...
  head: () => ({
    meta: [
      { title: "Submit a Query — EJAUIAPAR" },
      {
        name: "description",
        content:
          "Send a structured query to the EJAUIAPAR editorial or technical team and get a reply within two working days.",
      },
          ...
          <form onSubmit={onSubmit} className="rounded-2xl border border-border bg-card p-6 lg:p-8">
            ...
            <div className="mt-6 grid gap-5 sm:grid-cols-2">
              ...
              <Field
                ...
                name="submission_id"
                placeholder="EJAUIAPAR-2026-0123"
              />
              <div className="sm:col-span-2">
                <label className="block text-xs font-semibold uppercase tracking-wider text-muted-foreground">
                  Message *
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                Editorial:{" "}
                <a href="mailto:editorial@ejauiapar.com" className="text-brand hover:underline">
                  editorial@ejauiapar.com
                </a>
                <br />
                Support:{" "}
                <a href="mailto:support@ejauiapar.com" className="text-brand hover:underline">

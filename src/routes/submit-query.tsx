...
export const Route = createFileRoute("/submit-query")({
  head: () => ({
    meta: [
      { title: "Submit a Query — EJAUIAPAR" },
      { name: "description", content: "Send a structured query to the EJAUIAPAR editorial or technical team and get a reply within two working days." },
      { property: "og:title", content: "Submit a Query — EJAUIAPAR" },
...
function SubmitQuery() {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      toast.error("Something went wrong. Please email editorial@ejauiapar.com directly.");
    } finally {
      setLoading(false);
    }
  }
        ...
        <div className="grid gap-10 lg:grid-cols-[minmax(0,1fr)_320px]">
          <form onSubmit={onSubmit} className="rounded-2xl border border-border bg-card p-6 lg:p-8">
            ...
            <div className="mt-6 grid gap-5 sm:grid-cols-2">
              ...
              <Field label="Submission ID (if any)" name="submission_id" placeholder="EJAUIAPAR-2026-0123" />
              <div className="sm:col-span-2">
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-2xl border border-border bg-card p-6">
              ...
              <p className="mt-4 text-sm text-muted-foreground">
                Editorial: <a href="mailto:editorial@ejauiapar.com" className="text-brand hover:underline">editorial@ejauiapar.com</a>
                <br />
                Support: <a href="mailto:support@ejauiapar.com" className="text-brand hover:underline">support@ejauiapar.com</a>
              </p>
            </div>
          </aside>
        </div>

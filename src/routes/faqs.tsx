  ...
  head: () => ({
    meta: [
      { title: "Frequently Asked Questions — EJAUIAPAR" },
      {
        name: "description",
        content:
          "Answers to common questions about submission, peer review, publication charges, indexing, ethics, and post-publication support at EJAUIAPAR.",
      },
      { property: "og:title", content: "FAQs — EJAUIAPAR" },
      {
        property: "og:description",
        content: "Everything authors, reviewers, and readers ask about EJAUIAPAR.",
      },
    ],
...
const CATEGORIES = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes. EJAUIAPAR welcomes original research, review articles, technical notes, case studies, conceptual and theoretical papers, thesis notes, and book notes across healthcare, medicine, pharmacy, and allied disciplines.",
      },
      {
    ...
    items: [
      {
        ...
        a: "EJAUIAPAR enforces a maximum similarity index of 15% (excluding references and standard clauses). Manuscripts above this threshold are returned for substantive revision or rejected.",
      },
      {
      ...
      },
      {
        ...
        a: "EJAUIAPAR follows COPE guidelines. Corrections, expressions of concern, and retractions are issued transparently and linked to the original article.",
      },
    ],
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        a: "Yes — a verifiable certificate with a unique ID (EJAUIAPAR-YYYY-####) is issued to every author and can be validated on the Verify page.",
      },
    ],
  },
];

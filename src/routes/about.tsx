...
const FAQS = [
  {
    q: "Is EJAUIAPAR peer-reviewed?",
    a: "Yes. Every manuscript is evaluated through an external double-blind peer-review process by subject-matter reviewers.",
  },
  {
    q: "How often does EJAUIAPAR publish?",
    a: "EJAUIAPAR normally publishes four regular issues every year — in March, June, September, and December.",
  },
  {
  ...
  },
  {
    ...
    a: "Ayurveda, Unani Medicine, Siddha, Herbal Medicine, Pharmaceutical Sciences, Clinical Pharmacy, Integrative Medicine, Evidence-Based Healthcare, Allopathic Medicine, Drug Development, and interdisciplinary medical sciences. See Focus & Scope.",
  },
  {
        ...
        <section className="mt-14 grid gap-8 lg:grid-cols-[1.4fr_1fr]">
          <div>
            ...
            <p className="mt-5 text-muted-foreground leading-relaxed">
              The journal provides a professional platform for academicians, researchers, medical
              practitioners, clinicians, pharmacologists, policy makers, and healthcare
              professionals to communicate research findings, clinical trials, case studies,
              pharmacological reviews, and interdisciplinary developments in medical sciences.
            </p>
            ...
            <p className="mt-3 text-muted-foreground leading-relaxed">
              All manuscripts submitted to EJAUIAPAR are initially screened by the editorial office

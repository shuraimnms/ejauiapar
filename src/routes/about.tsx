...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About EJAUIAPAR — European Journal of Ayurvedic, Unani and Interdisciplinary Pharmaceuticals & Allopathic Review" },
      { name: "description", content: "EJAUIAPAR is an international peer-reviewed open-access journal dedicated to publishing high-quality research in Ayurveda, Unani Medicine, Siddha, Herbal Medicine, Pharmaceutical Sciences, Clinical Pharmacy, Integrative Medicine, Evidence-Based Healthcare, Allopathic Medicine, Drug Development, and interdisciplinary medical sciences that bridge traditional healing systems with modern healthcare innovations." },
      { property: "og:title", content: "About EJAUIAPAR" },
      { property: "og:description", content: "Peer-reviewed open-access journal in Ayurveda, Unani and Pharmaceutical Sciences with external double-blind peer review." },
    ],
...
const JOURNAL_DETAILS: [string, string][] = [
  ["Full Title", "European Journal of Ayurvedic, Unani and Interdisciplinary Pharmaceuticals & Allopathic Review"],
  ["Abbreviation", "EJAUIAPAR"],
  ...
  ["Website", "ejauiapar.com"],
  ["Editorial Email", "editor@ejauiapar.com"],
];
...
const FAQS = [
  { q: "Is EJAUIAPAR peer-reviewed?", a: "Yes. Every manuscript is evaluated through an external double-blind peer-review process by subject-matter reviewers." },
  { q: "How often does EJAUIAPAR publish?", a: "EJAUIAPAR normally publishes four regular issues every year — in March, June, September, and December." },
  ...
  { q: "Which subject areas are accepted?", a: "Ayurveda, Unani Medicine, Siddha, Herbal Medicine, Pharmaceutical Sciences, Clinical Pharmacy, Integrative Medicine, Evidence-Based Healthcare, Allopathic Medicine, Drug Development, and interdisciplinary medical sciences. See Focus & Scope." },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        title="European Journal of Ayurvedic, Unani and Interdisciplinary Pharmaceuticals & Allopathic Review"
        intro="EJAUIAPAR is an international peer-reviewed open-access journal dedicated to publishing high-quality research in Ayurveda, Unani Medicine, Siddha, Herbal Medicine, Pharmaceutical Sciences, Clinical Pharmacy, Integrative Medicine, Evidence-Based Healthcare, Allopathic Medicine, Drug Development, and interdisciplinary medical sciences that bridge traditional healing systems with modern healthcare innovations."
      >
      ...
      <div className="container-page py-12">
        ...
        <section className="mt-14 grid gap-8 lg:grid-cols-[1.4fr_1fr]">
          <div>
            ...
            <p className="mt-5 text-muted-foreground leading-relaxed">
              The journal provides a professional platform for academicians, researchers, medical practitioners, clinicians, pharmacologists, policy makers, and healthcare professionals to communicate research findings, clinical trials, case studies, pharmacological reviews, and interdisciplinary developments in medical sciences.
            </p>
            ...
            <p className="mt-3 text-muted-foreground leading-relaxed">
              All manuscripts submitted to EJAUIAPAR are initially screened by the editorial office for relevance, originality, formatting, plagiarism, language quality, ethical compliance, and adherence to journal guidelines. Manuscripts found suitable are evaluated through an external double-blind peer-review process.
            </p>
          </div>
        ...
        <CtaStrip
          ...
          title="Submit your manuscript to EJAUIAPAR"

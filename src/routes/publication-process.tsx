  ...
  head: () => ({
    meta: [
      { title: "Publication Process — EJAUIAPAR" },
      {
        name: "description",
        content:
          "The end-to-end EJAUIAPAR publication journey: submission, editorial screening, double-blind review, decision, production, DOI registration, and post-publication support.",
      },

...
export const Route = createFileRoute("/associate-editors")({
  head: () => ({
    meta: [
      { title: "Associate Editors — EJAUIAPAR" },
      { name: "description", content: "Meet the subject editors who handle submissions across finance, marketing, HR, operations, and strategy at EJAUIAPAR." },
      { property: "og:title", content: "Associate Editors — EJAUIAPAR" },
      { property: "og:description", content: "EJAUIAPAR's subject-specialist editorial team." },
    ],

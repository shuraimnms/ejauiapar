...
export const Route = createFileRoute("/articles")({
  head: () => ({
    meta: [
      { title: "Articles — EJAUIAPAR" },
      { name: "description", content: "Search and browse all peer-reviewed articles published in EJAUIAPAR." },
    ],
...
function Articles() {
  ...
  return (
    <SiteLayout>
      <PageHero eyebrow="Library" title="All articles" intro="Search across every peer-reviewed paper published in EJAUIAPAR." />

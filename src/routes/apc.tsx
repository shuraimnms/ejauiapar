...
export const Route = createFileRoute("/apc")({
  head: () => ({
    meta: [
      { title: "Publication Charges — EJAUIAPAR" },
      { name: "description", content: "EJAUIAPAR's publication charges policy, waiver conditions, refund terms, and ethical safeguards for authors." },
      { property: "og:title", content: "Publication Charges — EJAUIAPAR" },
      { property: "og:description", content: "Publication and processing charges policy for EJAUIAPAR." },
    ],

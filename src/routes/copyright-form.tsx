...
export const Route = createFileRoute("/copyright-form")({
  head: () => ({
    meta: [{ title: "Copyright Form — EJAUIAPAR" }, { name: "description", content: "Fillable Copyright Assignment Form for EJAUIAPAR manuscripts." }],
...
function CopyrightForm() {
  ...
  const generatePDF = () => {
    ...
    if (!w) return;
    w.document.write(`<html><head><title>EJAUIAPAR Copyright Form — ${state.manuscriptTitle}</title>
...
<h1>European Journal of Ayurvedic, Unani and Interdisciplinary Pharmaceuticals & Allopathic Review</h1>
...
<p>The undersigned assigns to EJAUIAPAR first-publication rights and the non-exclusive right to distribute the article under CC BY-NC 4.0, while retaining copyright.</p>
<h2>Signature</h2>

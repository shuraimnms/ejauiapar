...
export const Route = createFileRoute("/publication-ethics")({
  head: () => ({
    meta: [
      { title: "Publication Ethics & Malpractice Statement — EJAUIAPAR" },
      { name: "description", content: "EJAUIAPAR follows COPE guidelines for authorship, peer review, conflicts of interest, plagiarism, corrections, and retractions." },
      { property: "og:title", content: "Publication Ethics — EJAUIAPAR" },
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="EJAUIAPAR follows the Committee on Publication Ethics (COPE) Core Practices. Everyone in our workflow — authors, reviewers, editors — is bound by these standards."
      />
      <div className="container-page py-12">
        ...
        <CtaStrip
          ...
          intro="If you suspect ethical breach, plagiarism, or misconduct in any EJAUIAPAR article, please write to the Editor-in-Chief. We investigate every credible allegation."
          actions={[

...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — EJAUIAPAR" },
      { name: "description", content: "Contact the EJAUIAPAR editorial office for submissions, editorial enquiries, reviewer registration, ethics complaints, and technical support." },
      { property: "og:title", content: "Contact — EJAUIAPAR" },
      { property: "og:description", content: "Editorial office and enquiry channels for EJAUIAPAR." },
    ],
          ...
          <div>
            ...
            >
              ...
              <label className="flex items-start gap-2 text-xs text-muted-foreground">
                ...
                <span>I consent to EJAUIAPAR storing the information above solely to respond to my enquiry.</span>
              </label>
          ...
          <aside className="space-y-6">
            <div className="rounded-2xl border border-border bg-card p-6 text-sm">
              ...
              <div className="mt-4 space-y-3">
                ...
                <div className="flex items-start gap-3"><Globe className="mt-0.5 h-4 w-4 text-brand" /><span>ejauiapar.com</span></div>

  ...
  head: () => ({
    meta: [
      { title: "Contact — EJAUIAPAR" },
      {
        name: "description",
        content:
          "Contact the EJAUIAPAR editorial office for submissions, editorial enquiries, reviewer registration, ethics complaints, and technical support.",
      },
      { property: "og:title", content: "Contact — EJAUIAPAR" },
      {
        property: "og:description",
        content: "Editorial office and enquiry channels for EJAUIAPAR.",
      },
    ],
          ...
          <div>
            ...
            >
              ...
              <label className="flex items-start gap-2 text-xs text-muted-foreground">
                ...
                <span>
                  I consent to EJAUIAPAR storing the information above solely to respond to my
                  enquiry.
                </span>
              </label>
              <button

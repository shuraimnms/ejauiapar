  ...
  head: () => ({
    meta: [
      { title: "Articles In Press — EJAUIAPAR" },
      {
        name: "description",
        content:
          "Accepted EJAUIAPAR manuscripts in final production, awaiting issue assignment and DOI registration.",
      },
      { property: "og:title", content: "Articles In Press — EJAUIAPAR" },
      {
        property: "og:description",
        content: "Peer-reviewed manuscripts in final production at EJAUIAPAR.",
      },
    ],

  ...
  head: () => ({
    meta: [
      { title: "Publication Frequency — EJAUIAPAR" },
      {
        name: "description",
        content:
          "EJAUIAPAR publishes four regular quarterly issues every year — March, June, September, and December — with occasional special and theme-based issues.",
      },
      { property: "og:title", content: "Publication Frequency — EJAUIAPAR" },
      {
        property: "og:description",
        content: "Quarterly publication schedule and special-issue policy of EJAUIAPAR.",
      },
    ],

...
export const Route = createFileRoute("/publication-timeline")({
  head: () => ({
    meta: [
      { title: "Publication Frequency — EJAUIAPAR" },
      { name: "description", content: "EJAUIAPAR publishes four regular quarterly issues every year — March, June, September, and December — with occasional special and theme-based issues." },
      { property: "og:title", content: "Publication Frequency — EJAUIAPAR" },
      { property: "og:description", content: "Quarterly publication schedule and special-issue policy of EJAUIAPAR." },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        intro="EJAUIAPAR normally publishes four regular issues every year on a quarterly basis."
      />
      <div className="container-page py-12">
        ...
        <section className="mt-12">
          ...
          <div className="mt-2 rule-gold" />
          <p className="mt-3 text-sm text-muted-foreground">EJAUIAPAR may also publish:</p>

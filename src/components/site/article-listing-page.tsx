...
> = {
  latest: {
    ...
    intro:
      "The newest research from EJAUIAPAR — original studies, reviews, and conceptual pieces, freshly indexed and open to read.",
  ...
  "most-viewed": {
    ...
    intro:
      "The most-read EJAUIAPAR articles across all issues — a live snapshot of what's driving conversation in commerce and management research.",
    crumb: "Most Viewed",
    empty:
  ...
  "most-cited": {
    ...
    intro:
      "EJAUIAPAR articles that have accumulated the most citations across Crossref, Scholar, and partner databases.",
    crumb: "Most Cited",
    empty:

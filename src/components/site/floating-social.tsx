...
const SOCIALS = [
  { label: "Facebook", href: "https://facebook.com/ejauiapar", icon: Facebook, color: "#1877F2" },
  { label: "Instagram", href: "https://instagram.com/ejauiapar", icon: Instagram, color: "#E4405F" },
  { label: "Twitter / X", href: "https://twitter.com/ejauiapar", icon: Twitter, color: "#0f1419" },
  { label: "LinkedIn", href: "https://linkedin.com/company/ejauiapar", icon: Linkedin, color: "#0A66C2" },
];
...
const ANSWERS: Record<string, string> = {
  ...
  "What is the APC?":
    "EJAUIAPAR charges a nominal Article Processing Charge to support open-access publication. See the APC page for current rates and waivers.",
  "How long is peer review?":
  ...
  "How can I verify a certificate?":
    "Use the Verify page and enter the certificate ID (format: EJAUIAPAR-YYYY-####).",
};

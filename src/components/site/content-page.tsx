      ...
      <div className="min-w-0 space-y-10">
        <section className="relative overflow-hidden rounded-2xl border border-brand/30 bg-gradient-to-br from-brand-muted/50 via-background to-background p-8 lg:p-10">
          ...
          <div className="relative">
            ...
            <p className="mt-4 max-w-2xl text-muted-foreground leading-relaxed">
              {intro ??
                `Detailed material for this section is being finalised by the EJAUIAPAR editorial office. Meanwhile, everything you need to plan a submission, understand our review workflow, or reach the editors is available through the resources below.`}
            </p>
          </div>
        </section>
        ...
        <section className="rounded-2xl border border-border bg-card p-8">
          ...
          <p className="mt-4 text-sm leading-relaxed text-muted-foreground">
            EJAUIAPAR is committed to transparent, ethical, and internationally-benchmarked academic

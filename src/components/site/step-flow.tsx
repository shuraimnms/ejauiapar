          ...
          return (
            <Fragment key={s.title}>
              <li
                ...
                style={
                  active
                    ? { animation: `ejauiapar-step-pop 0.55s cubic-bezier(0.34,1.56,0.64,1) ${nodeDelay} both` }
                    : undefined
                }
              >
                <div
                ...
                >
                  ...
                  {active && (
                    <span
                      ...
                      style={{
                        animation: `ejauiapar-step-ring 1.1s ease-out ${nodeDelay} both`,
                  ...
                  <div className="relative h-[2px] w-full origin-left opacity-0"
                    style={
                      active
                        ? {
                            background: "var(--gold)",
                            animation: `ejauiapar-step-arrow 0.4s ease-out ${arrowDelay} both`,
                          }
                        : { background: "var(--gold)" }
                    }
                  >

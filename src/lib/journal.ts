...
// Nav structure mirrors the EJAUIAPAR policy document's site map.
...
export const JOURNAL = {
  ...
  frequency: "Quarterly",
  founded: 2021,
  email: "editor@ejauiapar.com",
  address: "Editorial Office, EJAUIAPAR, Europe",
} as const;
...
export const NAV: NavGroup[] = [
...

  {
    ...
    items: [
      ...
      { label: "Vision", to: "/vision-mission", description: "Long-term vision of EJAUIAPAR." },
...

  {
    ...
    items: [
      ...
      { label: "Ayurveda & Unani", to: "/aims-scope", description: "Traditional and herbal medicine." },
      { label: "Pharmaceuticals", to: "/aims-scope", description: "Drug discovery and clinical pharmacy." },
      { label: "Allopathic Medicine", to: "/aims-scope", description: "Internal and general medicine." },
      { label: "Integrative Healthcare", to: "/aims-scope", description: "Holistic and complementary medicine." },
      { label: "Public Health", to: "/aims-scope", description: "Community health and nutrition." },
      { label: "Biomedical Sciences", to: "/aims-scope", description: "Biotech, immunology, and pathology." },
      { label: "Clinical Research", to: "/aims-scope", description: "Clinical trials and evidence-based medicine." },
      { label: "Healthcare Management", to: "/aims-scope", description: "Digital health and patient safety." },
    ],
  },
...

  {
    ...
    items: [
      ...
      { label: "Case Studies", to: "/articles", description: "Case studies published in EJAUIAPAR." },
...

  {
    ...
    items: [
      ...
      { label: "Publication", to: "/publication-process", description: "Final publication in EJAUIAPAR." },
    ],
  },

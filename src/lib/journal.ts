...
export const NAV: NavGroup[] = [
...

  {
    ...
    items: [
      ...
      {
        label: "Ayurveda & Unani",
        to: "/aims-scope",
        description: "Traditional and herbal medicine.",
      },
      {
        label: "Pharmaceuticals",
        to: "/aims-scope",
        description: "Drug discovery and clinical pharmacy.",
      },
      {
        label: "Allopathic Medicine",
        to: "/aims-scope",
        description: "Internal and general medicine.",
      },
      {
        label: "Integrative Healthcare",
        to: "/aims-scope",
        description: "Holistic and complementary medicine.",
      },
      { label: "Public Health", to: "/aims-scope", description: "Community health and nutrition." },
      {
        label: "Biomedical Sciences",
        to: "/aims-scope",
        description: "Biotech, immunology, and pathology.",
      },
      {
      ...
      },
      {
        ...
        to: "/aims-scope",
        description: "Digital health and patient safety.",
      },
    ],
  },
...

  {
    ...
    items: [
      ...
      { label: "Review Articles", to: "/articles", description: "Review articles across issues." },
      {
        label: "Case Studies",
        to: "/articles",
        description: "Case studies published in EJAUIAPAR.",
      },
      {
...

  {
    ...
    items: [
      ...
      },
      {
        label: "Publication",
        to: "/publication-process",
        description: "Final publication in EJAUIAPAR.",
      },
    ],
  },
